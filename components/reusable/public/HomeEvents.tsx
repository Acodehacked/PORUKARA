...
const AdmssionForm = () => {
    return <div className='w-full mb-20 min-h-[50vh] bg-primary flex justify-center items-center font-bold text-white text-[50px] flex-col overflow-hidden'>
        ...
        <div className='mt-10 gap-2 flex md:flex-row flex-col'>
            <Link className='sm:text-[23px] text-[18px] font-medium flex items-center gap-3 p-3 border-2 border-white/50 rounded-sm hover:bg-white/40 hover:text-foreground transition-all duration-200' href={'/assets/applicationform.pdf'}>Download Admission Form <DownloadCloud /></Link>
