...
export function AdminLoginSection() {
    ...
    return (
        <div className="min-h-[90vh] h-full items-center bg-zinc-50 flex justify-center flex-col">
            ...
            <div className="border-[0.01rem] mt-[-100px] bg-white border-zinc-200 rounded-sm shadow-zinc-200 shadow-[0px_0px_50px] items-center h-full max-w-[400px] w-full space-y-3">
                <div className="px-4 pt-3">
                    <h1 className="text-[15px] text-secondary">Login</h1>
                    <h1 className=" text-[24px]">Office / Administrator</h1>
                </div>
                <hr />
                <Form {...form}>
