    ...
    return <section className="relative">
        <main className="screen z-[1] pt-[100px] min-h-[100vh] ">
            <div className="w-full flex md:justify-between flex-col md:flex-row items-center md:items-end md:p-2 p-4" >
                {/* <h1 className="text-[50px] font-semibold w-full mt-[40px]">Computer Science</h1> */}
                <SlideupText text="Computer-Science" className="text-[50px] font-semibold w-full mt-[40px]"/>
                <div className="w-full flex flex-col items-end">
                    <p className="text-primary me-2">Next</p>
                    <Button className="" variant={"outline"} asChild><Link href={"/Departments/Commerce"}>Commerce</Link></Button>
                </div>
            </div>
            <p className="md:px-2 px-4">Departments {'>'} Commerce</p>
            <div className="p-3 mt-5 text-[17px] flex gap-3 md:flex-row flex-col">
                <Image className="[object-fit:'cover']" alt="" src={'/assets/bca.jpg'} objectFit="cover" width={500} height={500} />
                <div className="px-3 py-4 mt-5 bg-white relative">
                    <Image alt="" src={'/assets/bg.jpg'} width={100} height={50} className="absolute top-0 right-[20px]" />
                    <p className="p-5 text-secondary border-b border-muted mb-3 font-semibold">About CS Department</p>
