...
export const metadata: Metadata = {
    title: 'Departments',
    description: 'Departments of Fr. Porukara CMI College,Champakulam'
}
export default function page() {
    return <section className="relative">
        <main className="screen z-[1] pt-[100px] min-h-[100vh] ">
            ...
            <SlideupText text="Our-Departments" className="text-[50px] font-semibold w-full mt-[40px]"/>
            ...
            <div className="p-3 mt-5 text-[17px] flex gap-3 md:flex-row flex-col">
                <Image className="[object-fit:'cover']" alt="" src={'/assets/bcom1.jpg'} objectFit="cover" width={500} height={500} />
