...
export const metadata: Metadata = {
    title: 'National Service Scheme Report | Fr. Porukara CMI College',
    description: 'Report of the National Service Scheme of Fr. Porukara CMI College,Champakulam'
}
export default function Page() {
    return <main className="screen min-h-[100vh] pt-[180px]">
        <div className="flex items-center gap-3 justify-center">
            <Image src={'/assets/nss-logo.webp'} width={100} height={100} className="rounded-full" alt="Nss logo" />
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col gap-2 px-6">
                <p className="text-[15px] text-justify pe-2">
                    <Image src={'/assets/nss-logo.webp'} width={70} height={70} className="rounded-full" alt="Nss logo" />
                ...
                <Image src={'/assets/1.webp'} alt="" width={300} height={100} className="md:max-w-[490px] w-full rounded-2xl" />
            </div>
        </div>
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex flex-col gap-2 px-6">
                ...
                <div className="flex md:flex-row flex-col w-full px-4 gap-4 overflow-hidden"> 
                    <Image src={'/assets/2.webp'} alt="" width={600} height={200} className="md:max-w-[600px] h-[200px]  aspect-video w-full rounded-2xl" />
                    <Image src={'/assets/3.webp'} alt="" width={300} height={100} className="w-auto h-[200px] rounded-2xl" />
                </div>
            </div>
        </div>
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col gap-2 px-6">
                ...
                <Image src={'/assets/4.webp'} alt="" width={900} height={50} className="md:max-w-[50%] rounded-2xl mt-10" />
            </div>
        </div>
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col gap-2 px-6">
                ...
                <Image src={'/assets/5.webp'} alt="" width={300} height={100} className="md:max-w-[290px] w-full rounded-2xl" />
            </div>
        </div>
        ...
        <div className="bg-white mt-4 p-4">
            ...
            <div className="p-3">
                <Image src={'/assets/6.webp'} alt="" width={900} height={300} className="md:max-w-[590px] w-full rounded-2xl" />
            </div>
        </div>
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col gap-2 px-6">
                ...
                <Image src={'/assets/7.webp'} alt="" width={300} height={100} className="md:max-w-[390px] w-full rounded-2xl" />
            </div>
        </div>

        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col-reverse gap-2 px-6">
                <Image src={'/assets/8.webp'} alt="" width={300} height={100} className="md:max-w-[390px] w-full rounded-2xl" />
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col gap-2 px-6">
                ...
                <Image src={'/assets/9.webp'} alt="" width={300} height={100} className="md:max-w-[390px] w-full mt-6 rounded-2xl" />
            </div>
        </div>
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col-reverse gap-2 px-6">
                ...
                <Image src={'/assets/10.webp'} alt="" width={300} height={100} className="md:max-w-[390px] w-full rounded-2xl" />
            </div>
        </div>

        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col-reverse gap-2 px-6">
                <Image src={'/assets/11.webp'} alt="" width={300} height={100} className="md:max-w-[390px] w-full rounded-2xl" />
                <p className="text-[15px] text-justify ps-3">
                    <Image src={'/assets/nss-logo.webp'} width={70} height={70} className="rounded-full" alt="Nss logo" />
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col gap-2 px-6">
                ...
                <div className="mx-auto w-full max-w-[390px]">
                    <Image src={'/assets/12.webp'} alt="" width={300} height={100} className=" w-full rounded-2xl" />
                </div>
            </div>
        </div>
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col-reverse gap-2 px-6">
                <div className="mx-auto w-full max-w-[290px]">
                    <Image src={'/assets/13.webp'} alt="" width={300} height={100} className=" w-full rounded-2xl" />
                </div>
                <p className="text-[15px] text-justify ps-3">
                    <Image src={'/assets/nss-logo.webp'} width={70} height={70} className="rounded-full" alt="Nss logo" />
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col gap-2 px-6">
                ...
                <Image src={'/assets/14.webp'} alt="" width={300} height={100} className="md:max-w-[490px] w-full rounded-2xl" />
            </div>
        </div>

        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col-reverse gap-2 px-6">
                <Image src={'/assets/15.webp'} alt="" width={300} height={100} className="md:max-w-[250px] w-full rounded-2xl" />
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col gap-2 px-6">
                ...
                <Image src={'/assets/16.webp'} alt="" width={300} height={200} className="md:max-w-[590px] max-h-[400px] h-full w-full rounded-2xl" />
            </div>
        </div>
        ...
        <div className="bg-white mt-4 p-4">
            <div className="flex md:flex-row flex-col-reverse gap-2 px-6">
                <div className="mx-auto w-full max-w-[290px]">
                    <Image src={'/assets/17.webp'} alt="" width={300} height={100} className=" w-full rounded-2xl" />
                </div>
                <p className="text-[15px] text-justify ps-3">
                    <Image src={'/assets/nss-logo.webp'} width={70} height={70} className="rounded-full" alt="Nss logo" />
        ...
        <div className="bg-white mt-4 p-4">
            ...
            <div className="flex flex-wrap p-3 gap-3">
                <Image src={'/assets/18.webp'} alt="" width={300} height={100} className=" w-auto rounded-2xl" />
                <Image src={'/assets/19.webp'} alt="" width={300} height={100} className=" w-auto rounded-2xl" />
                <Image src={'/assets/20.webp'} alt="" width={300} height={100} className=" w-auto rounded-2xl" />
            </div>
        </div>
    </main>
}
