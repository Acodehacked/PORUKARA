                        ...
                        <div className='max-w-[500px] w-full flex flex-col items-center rounded-sm bg-white px-3 py-2'>
                            <div className='flex justify-between w-full'>
                                <div className='w-full flex items-center gap-2'>
                                    <img src={'/assets/app/app_logo.webp'} width={20} height={20} alt="Kuttanad App" />
                            ...
                            <img src={'/assets/app/apps.webp'} width={300} height={100} alt="Kuttanad App" />
                            <img src={'/assets/app/google_play.webp'} width={250} height={100} alt="Kuttanad App" />
                        </div>
                    </motion.div>
                }
            </AnimatePresence>
